...
@dataclass
class DMDRTrainingArguments(TrainingArguments):
    r"""Training arguments for DMDR (Distribution Matching Distillation + RL)."""

    # Dual model
    learning_rate_gui: Optional[float] = field(
        default=None,
        metadata={"help": "Learning rate for guidance model. Defaults to learning_rate at runtime."},
    )
